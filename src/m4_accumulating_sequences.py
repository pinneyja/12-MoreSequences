...
def rectangles_from_circles(circles):
    ...
    for circle in circles:
        first_x = circle.center.x - circle.radius
        first_y = circle.center.y - circle.radius
        second_x = circle.center.x + circle.radius
        second_y = circle.center.y + circle.radius
        point1 = rg.Point(first_x, first_y)
        point2 = rg.Point(second_x, second_y)
